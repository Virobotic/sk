    ...
    return (
      <main className="page-content">
        <div className="detail-page-card">
          ...
          <p>
            We could not find a tribe for the slug <strong>{slug}</strong>.
          </p>
          <Link to="/tribes" className="button secondary">
            Back to tribe directory
          </Link>
        </div>
      </main>
    );
          ...
          <div className="stack">
            <div className="detail-list">
              ...
              <div>
                ...
                <span>{tribe.festival}</span>
              </div>
              <div>
                <strong>Livelihood</strong>
                <span>{tribe.primaryLivelihood}</span>
              </div>
              <div>
                <strong>Slug</strong>
                <code>{`/tribes/${tribe.slug}`}</code>
              </div>
              <div>
                <strong>Tags</strong>
                <span>{tribe.tags.join(", ")}</span>
              </div>
            </div>
            ...
            <div className="detail-action-row">
              ...
              <a href={mapSrc} target="_blank" rel="noreferrer" className="button primary">
                Open satellite map
              </a>
            </div>
          </div>
